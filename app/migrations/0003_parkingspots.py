    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latitude', models.DecimalField(decimal_places=6, help_text='GPS lat bounded by ['
                                                                         '-90,90] and with 6 decimal places', max_digits=9)),
                ('longitude', models.DecimalField(decimal_places=6, help_text='GPS lng bounded by ('
                                                                        '-180, 180] with 6 decimal places', max_digits=9)),
