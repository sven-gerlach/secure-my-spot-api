...
class TestParkingSpotModel:
    ...
    def test_create_valid_parking_spot(self, parking_spot):
        ...
        assert new_parking_spot.lat == parking_spot.lat
        assert new_parking_spot.lng == parking_spot.lng
        assert new_parking_spot.rate == parking_spot.rate

    def test_create_parking_spot_invalid_lat(self):
        """
    ...
    def test_utility_method(self, parking_spot):
        ...
        spot model instance.
        """
        assert parking_spot.get_coordinates == f"{parking_spot.lat},{parking_spot.lng}"
        ...
        assert parking_spot.get_dictionary("lat", "lng", "rate") == {
            "lat": parking_spot.lat,
            "lng": parking_spot.lng,
